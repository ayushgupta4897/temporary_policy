...
class AzureTableClient:
    ...
    def list_queries(self, query_type: str = "policy") -> List[Dict]:
        """List queries filtered by type (policy, graph, contextual_search, or news_scrape)."""
        if query_type == "policy":
            ...
            select_fields = ["RowKey", "query", "status", "createdAt", "completedAt", "errorMessage", "durationMinutes", "citationsCount", "displayTitle", "analysisMode", "geography", "timeRange", "intervention", "nodeCount", "edgeCount"]
        ...
        for entity in entities:
            ...
            if query_type == "contextual_search":
