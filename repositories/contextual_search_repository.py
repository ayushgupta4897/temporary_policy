"""
Contextual Search Repository - DUMB CRUD operations only
...
class ContextualSearchRepository:
    """Repository for contextual search query data persistence."""
    ...
    def create_query(self, query_id: str, query_text: str, display_title: str,
                    analysis_mode: str = "contextual_search", metadata: Dict = None) -> bool:
        """Create a new contextual search query record."""
    ...
    def get_query(self, query_id: str) -> Optional[Dict]:
        """Get a contextual search query by ID."""
        return self.table_client.get_query(query_id)

    def list_queries(self, query_type: str = "contextual_search") -> List[Dict]:
    ...
    def delete_query(self, query_id: str) -> bool:
        """Delete a contextual search query."""
    ...
    def upload_report(self, query_id: str, filename: str, content: str) -> str:
        """Upload a search result to blob storage."""
